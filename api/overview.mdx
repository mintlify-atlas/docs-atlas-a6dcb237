...
<CardGroup cols={2}>
  <Card title="Users" icon="user" href="/api/users/register-login">
    Registration, login, token refresh, profile updates, and avatar management.
  </Card>
  <Card title="Videos" icon="video" href="/api/videos/upload-publish">
    Upload videos with Cloudinary, fetch feeds, update metadata, and manage publish status.
  </Card>
  <Card title="Social Features" icon="heart" href="/api/social/comments">
    Likes, comments, and channel subscriptions across the platform.
  </Card>
  <Card title="Dashboard" icon="chart-bar" href="/api/dashboard/stats">
