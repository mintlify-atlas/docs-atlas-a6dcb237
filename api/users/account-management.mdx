---
title: "Update Account Details, Avatar, and Password"
sidebarTitle: "Account Management"
description: "Change your VideoHub account's display name, avatar image, cover image, and password. All endpoints require authentication."
---
...
<Note>
  Only `fullName` is accepted by this endpoint. To change your `username` or `email`, contact platform support — those fields carry uniqueness constraints and require additional verification.
</Note>
