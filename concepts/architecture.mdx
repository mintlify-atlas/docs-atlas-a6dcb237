...
description: "VideoHub uses a decoupled monorepo with an Express REST API backend and a React 19 SPA frontend. Learn how the layers connect and fit together."
---
