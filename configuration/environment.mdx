---
title: "Environment Variables Reference for VideoHub"
sidebarTitle: "Environment Variables"
description: "Complete reference for all VideoHub backend environment variables: server, database, JWT, Cloudinary, and default asset configuration."
---
...
<ParamField path="HOST" type="string" default="0.0.0.0">
  The network interface address the server listens on. `0.0.0.0` binds to all available interfaces, which is correct for most Docker and cloud deployments. Use `127.0.0.1` to restrict access to localhost only during development.
</ParamField>
